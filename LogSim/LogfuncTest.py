...
class AndGateTest(unittest.TestCase):
    ...
    def testcase_05(self):
        a = AndGate(3)
        self.assertEqual(False, a.Output, "Class AndGate Testcase 5 failed.")
    ...
    def testcase_06(self):
        ...
        a.set_input(2,False)
        a.execute()
        self.assertEqual(False, a.Output, "Class AndGate Testcase 6 failed.")
    ...
    def testcase_07(self):
        ...
        a.set_input(2,False)
        a.execute()
        self.assertEqual(False, a.Output, "Class AndGate Testcase 7 failed.")
    ...
    def testcase_08(self):
        ...
        a.set_input(2,True)
        a.execute()
        self.assertEqual(False, a.Output, "Class AndGate Testcase 8 failed.")
    ...
    def testcase_09(self):
        ...
        a.set_input(2,True)
        a.execute()
        self.assertEqual(True, a.Output, "Class AndGate Testcase 9 failed.")
...
class OrGateTest(unittest.TestCase):
    ...
    def testcase_05(self):
        a = OrGate(4)
        self.assertEqual(False, a.Output, "Class OrGate Testcase 5 failed.")
    ...
    def testcase_06(self):
        ...
        a.set_input(3,False)
        a.execute()
        self.assertEqual(False, a.Output, "Class OrGate Testcase 6 failed.")
    ...
    def testcase_07(self):
        ...
        a.set_input(3,False)
        a.execute()
        self.assertEqual(True, a.Output, "Class OrGate Testcase 7 failed.")
    ...
    def testcase_08(self):
        ...
        a.set_input(3,True)
        a.execute()
        self.assertEqual(True, a.Output, "Class OrGate Testcase 8 failed.")
    ...
    def testcase_09(self):
        ...
        a.set_input(3,True)
        a.execute()
        self.assertEqual(True, a.Output, "Class OrGate Testcase 9 failed.")
...
class NandGateTest(unittest.TestCase):
    ...
    def testcase_05(self):
        a = NandGate(4)
        self.assertEqual(True, a.Output, "Class NandGate Testcase 5 failed.")
    ...
    def testcase_06(self):
        ...
        a.set_input(3,False)
        a.execute()
        self.assertEqual(True, a.Output, "Class NandGate Testcase 6 failed.")
    ...
    def testcase_07(self):
        ...
        a.set_input(3,False)
        a.execute()
        self.assertEqual(True, a.Output, "Class NandGate Testcase 7 failed.")
    ...
    def testcase_08(self):
        ...
        a.set_input(3,False)
        a.execute()
        self.assertEqual(True, a.Output, "Class NandGate Testcase 8 failed.")
    ...
    def testcase_09(self):
        ...
        a.set_input(3,True)
        a.execute()
        self.assertEqual(False, a.Output, "Class NandGate Testcase 9 failed.")
...
class XORGateTest(unittest.TestCase):
    ...
    def testcase_05(self):
        a = XORGate(3)
        self.assertEqual(False, a.Output, "Class XORGate Testcase 5 failed.")
    ...
    def testcase_06(self):
        ...
        a.set_input(2,False)
        a.execute()
        self.assertEqual(False, a.Output, "Class XORGate Testcase 6 failed.")
    ...
    def testcase_07(self):
        ...
        a.set_input(2,False)
        a.execute()
        self.assertEqual(True, a.Output, "Class XORGate Testcase 7 failed.")
    ...
    def testcase_08(self):
        ...
        a.set_input(2,True)
        a.execute()
        self.assertEqual(False, a.Output, "Class XORGate Testcase 8 failed.")
    ...
    def testcase_09(self):
        ...
        a.set_input(2,True)
        a.execute()
        self.assertEqual(False, a.Output, "Class XORGate Testcase 9 failed.")
